    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          Integrate AgentProof to eliminate spam agents and build trust on your platform.
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Agent completes AgentProof verification and receives a proof token.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Agent includes their AgentProof token in the registration request.
                </p>
              </div>
            </div>
