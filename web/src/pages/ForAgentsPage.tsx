    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">
          Learn how to get verified and be trusted across the agent ecosystem.
        </p>
      </div>
      
      {/* CTA */}
      <div className="card p-4 mb-8 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border-purple-500/20">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p className="text-white font-medium">Ready to implement?</p>
            <p className="text-gray-400 text-sm">See the full API documentation with code examples.</p>
          </div>
